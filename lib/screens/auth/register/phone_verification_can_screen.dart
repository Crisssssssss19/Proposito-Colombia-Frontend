...
class PhoneVerificationCanScreen extends StatefulWidget {
  const PhoneVerificationCanScreen({super.key});

  @override
  State<PhoneVerificationCanScreen> createState() => _PhoneVerificationCanScreenState();
}

class _PhoneVerificationCanScreenState extends State<PhoneVerificationCanScreen> {
